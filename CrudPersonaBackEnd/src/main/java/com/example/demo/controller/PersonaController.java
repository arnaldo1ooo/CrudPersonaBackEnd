...
public class PersonaController {
	...
	public ResponseEntity<?> actualizar(@RequestBody Persona personaDetails, @PathVariable() Long personaId) {
		...
		// BeanUtils.copyProperties(personaDetails, oDepartamento); Sirve para copiar
		// directamente todo el objeto personaDetails a oDepartamento
	...
	// Borrar
	@DeleteMapping("borrar/{personaId}")
